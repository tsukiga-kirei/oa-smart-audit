...
const userRole = computed(() => currentUser.value?.role || 'system_admin')

const showTenantAdmin = true // System admin can access tenant admin
const showSystemAdmin = true
