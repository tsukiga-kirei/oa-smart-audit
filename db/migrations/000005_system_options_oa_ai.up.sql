...
INSERT INTO ai_model_configs
    (provider, provider_label, model_name, display_name, deploy_type,
     endpoint, api_key_configured, max_tokens, context_window, cost_per_1k_tokens,
     status, enabled, description, capabilities)
VALUES
    (
        'xinference', 'Xinference', 'Qwen2.5-72B', 'Qwen2.5-72B（本地）', 'local',
        'http://192.168.1.50:9997/v1', FALSE, 8192, 131072, 0,
        'online', TRUE,
        '通义千问2.5 72B 参数大模型，通过 Xinference 本地私有部署，数据不出域',
        '["text","code","reasoning","analysis"]'
    ),
    (
        'xinference', 'Xinference', 'Qwen2.5-32B', 'Qwen2.5-32B（本地）', 'local',
        'http://192.168.1.50:9997/v1', FALSE, 4096, 65536, 0,
        'online', TRUE,
        '通义千问2.5 32B 参数大模型，通过 Xinference 部署，适合轻量级审核任务',
        '["text","code","reasoning"]'
    ),
    (
        'aliyun_bailian', '阿里云百炼', 'qwen-plus', 'Qwen-Plus（阿里云百炼）', 'cloud',
        'https://dashscope.aliyuncs.com/compatible-mode/v1', TRUE, 16384, 131072, 0.008,
        'online', TRUE,
        '阿里云百炼 Qwen-Plus 大模型，云端部署，性价比高',
        '["text","code","reasoning","analysis"]'
    ),
    (
        'aliyun_bailian', '阿里云百炼', 'qwen-max', 'Qwen-Max（阿里云百炼）', 'cloud',
        'https://dashscope.aliyuncs.com/compatible-mode/v1', TRUE, 8192, 131072, 0.02,
        'online', FALSE,
        '阿里云百炼 Qwen-Max 旗舰模型，适合复杂合同和法务审核',
        '["text","code","reasoning","vision","analysis"]'
    ),
    (
        'xinference', 'Xinference', 'DeepSeek-V3', 'DeepSeek-V3（本地）', 'local',
        'http://192.168.1.51:9997/v1', FALSE, 8192, 65536, 0,
        'maintenance', FALSE,
        'DeepSeek V3 大模型，通过 Xinference 部署，擅长代码和推理任务',
        '["text","code","reasoning"]'
    ),
    (
        'deepseek', 'DeepSeek', 'deepseek-chat', 'DeepSeek Chat（云端）', 'cloud',
        'https://api.deepseek.com/v1', TRUE, 8192, 65536, 0.001,
        'online', TRUE,
        'DeepSeek Chat 云端模型，性价比极高',
        '["text","code","reasoning"]'
    ),
    (
        'ollama', 'Ollama', 'qwen2.5:14b', 'Qwen2.5-14B (Ollama)', 'local',
        'http://192.168.1.52:11434/v1', FALSE, 4096, 32768, 0,
        'offline', FALSE,
